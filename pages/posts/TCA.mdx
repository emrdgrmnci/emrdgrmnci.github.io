---
title: My journey with The Composable Architecture
description: 
date: 2023-08-16T08:35:28.178Z
tag: Architecture, TCA, SwiftUI
category: iOS Development
image: images/technology.jpg
author: Emre Degirmenci
---

In this article, I will give an introduction to The Composable Architecture (TCA) and show my example project.

## General Overview

> [The Composable Architecture (TCA, for short)](https://github.com/pointfreeco/swift-composable-architecture) is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind, developed by [Brandon Williams](https://github.com/mbrandonw) and [Stephen Celis](https://github.com/stephencelis) from Point-Free. It can be used in SwiftUI, UIKit, and more, and on any Apple platform (iOS, macOS, tvOS, and watchOS).

![TCA-Diagram!](/images/TCA-Diagram.png "TCA Diagram")
...
![!](/images/ss.gif "Screen video")

You can find the all the codes in [here](https://github.com/emrdgrmnci/MatchScoresTCA)